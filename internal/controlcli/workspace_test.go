...
func TestImprunWorkspaceUseVerifiesBeforePersisting(t *testing.T) {
...
func TestImprunWorkspaceUsePreservesContextWhenVerificationFails(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, request *http.Request) {
		w.Header().Set("Content-Type", "application/json")
...
func TestImprunWorkspaceListUsesGlobalRegistryEndpoint(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, request *http.Request) {
