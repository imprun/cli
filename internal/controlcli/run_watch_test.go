...
func TestImprunRunWatchPrintsSuccessfulResult(t *testing.T) {
...
func TestImprunRunWatchRejectsUnsafePollingIntervalBeforeRequest(t *testing.T) {
...
func TestImprunRunWatchReturnsCommandFailureForFailedRun(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, request *http.Request) {
