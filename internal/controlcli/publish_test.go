...
func TestImprunAppPublishRegistersSynchronizesAndPublishesExactCommit(t *testing.T) {
...
func TestImprunAppPublishRejectsResponseWithoutImmutableReleaseID(t *testing.T) {
...
func createPublishGitFixture(t *testing.T) (string, string, string) {
	...
	runPublishTestGit(t, repoRoot, "config", "user.email", "imprun-test@example.com")
