...
func TestImprunReleaseViewSelectsExactHistoryItem(t *testing.T) {
...
func TestImprunReleaseActivateRequiresAuditConfirmationAndUsesCanonicalEndpoint(t *testing.T) {
...
func runWFReleaseTest(t *testing.T, serverURL string, args ...string) (string, string, int) {
	...
	exit := RunImprun(fullArgs, strings.NewReader(""), &stdout, &stderr)
